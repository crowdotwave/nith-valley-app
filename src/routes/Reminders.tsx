...
export default function Reminders() {
  ...
  return (
    <main>
      ...
      {/* Staff-created reminders — the "back end" half of the requirement. */}
      {isStaff &&
        (adding ? (
          <form onSubmit={addReminder} className="stack">
            ...
            <input id="title" name="title" required placeholder="Annual wellness exam due" />
          ...
          <button onClick={() => setAdding(true)}>Add a reminder</button>
        ))}
    </main>
  );
}
